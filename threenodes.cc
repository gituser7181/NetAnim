...
main(int argc, char* argv[])
{
    ...
    address1.SetBase("0.0.0.0","255.255.255.0");

    Ipv4InterfaceContainer interfaces = address.Assign(devices),interfaces1 = address.Assign(devices1);
    ...
    AnimationInterface anim("threenodes.xml");
